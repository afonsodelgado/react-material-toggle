...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_stylis_rule_sheet__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_hoist_non_react_statics__ = __webpack_require__(9);
...
var TrackWrapper = _styledComponents2.default.div(_templateObject2, function (props) {
    return props.trackHeight;
}, function (props) {
    return props.trackWidth;
});

var Track = _styledComponents2.default.div(_templateObject3, function (props) {
    return props.trackWidth;
}, function (props) {
    return props.trackOffColor;
});

var Thumb = _styledComponents2.default.div(_templateObject4, function (props) {
    return props.thumbSize + 'px';
}, function (props) {
    return props.thumbSize + 'px';
}, function (props) {
    return props.thumbOffColor;
}, TrackWrapper);

var Tooltip = _styledComponents2.default.div(_templateObject5, function (props) {
    return props.thumbSize + 14 + 'px';
}, Container);
...
var Toggle = function (_Component) {
    ...
    function Toggle(props) {
        ...
        _this.handleToogle = function () {
            _this.setState({ isSelected: !_this.state.isSelected });
        };

        _this.componentWillUpdate = function (nextProps, nextState) {
            if (_this.props.onToggle && _this.state.isSelected !== nextState.isSelected) {
                _this.props.onToggle(nextState.isSelected);
            }
        };

        _this.componentDidUpdate = function () {
            var _this$props = _this.props,
                thumbOnColor = _this$props.thumbOnColor,
                trackOnColor = _this$props.trackOnColor,
                thumbOffColor = _this$props.thumbOffColor,
                trackOffColor = _this$props.trackOffColor;

            if (_this.state.isSelected) {
                _this.thumb.style.backgroundColor = thumbOnColor;
                _this.thumb.style.transform = 'translate(20px)';
                _this.track.style.backgroundColor = trackOnColor;
            } else {
                _this.thumb.style.backgroundColor = thumbOffColor;
                _this.track.style.backgroundColor = trackOffColor;
                _this.thumb.style.transform = 'translate(-10px)';
            }
        };
        ...
        _this.render = function () {
            var _this$props2 = _this.props,
                ...
                thumbOffColor = _this$props2.thumbOffColor,
                trackOffColor = _this$props2.trackOffColor,
                thumbOffIcon = _this$props2.thumbOffIcon,
                thumbOnIcon = _this$props2.thumbOnIcon,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    TrackWrapper,
                    { onClick: _this.handleToogle, trackHeight: trackHeight, trackWidth: trackWidth },
                    _react2.default.createElement(
                        Track,
                        ...
                        _react2.default.createElement(
                            ...
                            thumbOffIcon && thumbOnIcon ? _this.state.isSelected ? thumbOnIcon : thumbOffIcon : null
                        )
                    )
                ),
...
Toggle.propTypes = {
    thumbOnIcon: _propTypes2.default.element,
    thumbOffIcon: _propTypes2.default.element,
    trackHeight: _propTypes2.default.string,
    trackWidth: _propTypes2.default.string,
    thumbSize: _propTypes2.default.number,
    thumbOffColor: _propTypes2.default.string,
    thumbOnColor: _propTypes2.default.string,
    trackOffColor: _propTypes2.default.string,
    trackOnColor: _propTypes2.default.string,
